  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        >
          {[...Array(6)].map((_, i) => (
            <div key={i} className="h-full w-full bg-gradient-to-br from-primary/20 to-transparent rounded-full blur-3xl" />
          ))}
        </motion.div>
        <div className="container relative px-4 md:px-6">
          <motion.div variants={stagger} className="flex flex-col items-center space-y-4 text-center">
            ...
            <motion.div variants={fadeIn} className="flex flex-col sm:flex-row gap-4 sm:space-x-4">
              <Link href="/contact">
      ...
      >
        <div className="container px-4 md:px-6">
          ...
          <motion.div variants={stagger} className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            {[
              {
                title: "Content Creation",
                description: "Professional content that engages and converts your target audience.",
                features: ["Social Media Content", "Blog Posts & Articles", "Video Production", "Graphic Design"]
              },
              {
                title: "Strategy & Growth",
                description: "Data-driven strategies to grow your audience and increase engagement.",
                features: ["Market Research", "Competitor Analysis", "Growth Planning", "Performance Tracking"]
              },
              {
                title: "Community Building",
                description: "Build and nurture an engaged community around your brand.",
                features: ["Community Management", "Engagement Strategies", "Event Planning", "Brand Advocacy"]
              }
            ].map((service, index) => (
      ...
      >
        <div className="container px-4 md:px-6">
          <motion.div variants={stagger} className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              >
                ...
                <p className="text-gray-500 dark:text-gray-400 text-center">{stat.label}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      >
        ...
        />
        <div className="container relative px-4 md:px-6">
          <motion.div variants={stagger} className="flex flex-col items-center space-y-4 text-center text-white">
            <motion.div variants={fadeIn} className="space-y-2">
