...
const projects = [
  {
    ...
    image: 'https://placehold.co/600x400/2563eb/ffffff?text=Marketing+Dashboard',
  },
  {
  ...
  return (
    <section className="py-20 px-4 bg-muted/50">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-12 hover:text-primary transition-colors duration-300">Our Work</h2>
