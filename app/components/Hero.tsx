          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                ...
                <span className="text-xl font-semibold text-foreground">Organic Marketing</span>
              </motion.div>
              ...
              >
                ...
                <span className="text-sm text-muted-foreground">Trusted by 1000+ brands</span>
              </motion.div>
              ...
              >
                Join our network of creators and unlock exponential growth through strategic content and authentic engagement.
              </motion.p>
              ...
              >
                <div>
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">Organic Impressions</p>
                </div>
                <div>
                  <motion.h3 
                    initial={{ opacity: 0, y: 20 }}
